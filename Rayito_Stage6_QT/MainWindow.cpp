...
void MainWindow::on_renderButton_clicked()
{
    ...
    std::vector<Rayito::Face> faces0;
    std::vector<Rayito::Vector> normals0;
    std::vector<Rayito::Point> vertices0;
    vertices0.push_back(Rayito::Point(0.0f, -2.0f, -2.0f));
    vertices0.push_back(Rayito::Point(1.0f, -2.0f, -2.0f));
    vertices0.push_back(Rayito::Point(1.0f, -1.0f, -2.0f));
    vertices0.push_back(Rayito::Point(0.0f, -1.0f, -2.0f));
    vertices0.push_back(Rayito::Point(0.0f, -2.0f, -1.0f));
    vertices0.push_back(Rayito::Point(1.0f, -2.0f, -1.0f));
    vertices0.push_back(Rayito::Point(1.0f, -1.0f, -1.0f));
    vertices0.push_back(Rayito::Point(0.0f, -1.0f, -1.0f));
    faces0.push_back(Rayito::Face());
    faces0.back().m_vertexIndices.push_back(0);
    faces0.back().m_vertexIndices.push_back(1);
    faces0.back().m_vertexIndices.push_back(2);
    faces0.back().m_vertexIndices.push_back(3);
    faces0.push_back(Rayito::Face());
    faces0.back().m_vertexIndices.push_back(1);
    faces0.back().m_vertexIndices.push_back(5);
    faces0.back().m_vertexIndices.push_back(6);
    faces0.back().m_vertexIndices.push_back(2);
    faces0.push_back(Rayito::Face());
    faces0.back().m_vertexIndices.push_back(5);
    faces0.back().m_vertexIndices.push_back(4);
    faces0.back().m_vertexIndices.push_back(7);
    faces0.back().m_vertexIndices.push_back(6);
    faces0.push_back(Rayito::Face());
    faces0.back().m_vertexIndices.push_back(4);
    faces0.back().m_vertexIndices.push_back(0);
    ...
    faces0.back().m_vertexIndices.push_back(6);
    faces0.back().m_vertexIndices.push_back(7);
    Rayito::DiffuseMaterial reddishLambert(Rayito::Color(0.8f, 0.3f, 0.1f));
    ...
    Rayito::Sphere sphereForLight(Rayito::Point(1.0f, 0.5f, 2.0f),
                                  0.5f,
                                  &blueishLambert);
